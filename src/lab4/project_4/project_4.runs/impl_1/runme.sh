...
HD_PWD='C:/Users/student/project_4_Denis_Mihnea/project_4_Denis_Mihnea.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumator16.tcl -notrace
