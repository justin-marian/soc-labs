...
HD_PWD='C:/Users/student/project_4_Denis_Mihnea/project_4_Denis_Mihnea.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumator16.tcl
