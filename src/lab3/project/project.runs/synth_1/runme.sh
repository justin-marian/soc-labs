...
HD_PWD='C:/Users/sf/Desktop/emma/an2/sem2/soc/lab3/project/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log figura3_3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source figura3_3_wrapper.tcl
