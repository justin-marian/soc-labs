...
HD_PWD='C:/Users/sf/Desktop/emma/an2/sem2/soc/lab3/project/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log figura3_3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source figura3_3_wrapper.tcl -notrace
